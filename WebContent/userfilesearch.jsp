...
%>
<script>
	alert('Request Send to Cloud Successfully');
</script>
<%
	}
%>
...
<body>
	<div class="main">
		...
		<div class="loginBox">
			...
			<form method="get" action="userfilesearch1.jsp"
				enctype="multipart/form-data">



				<table>
					<b><h2>File Search by File Key</h2> <b> <br>
							<div class="form-group">
								<label for="upload">File Key:</label> <input type="text"
									name="filekey" placeholder="Enter File Name">
							</div>
