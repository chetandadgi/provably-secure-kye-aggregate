			...
			<div class="header_resize">
				...
				<div class="menu_nav">
					<ul>
						...
						<li class="active"><a href="ownerdetails.jsp"><span>Owner
									Request</span></a></li>
						<li><a href="UserDetails.jsp"><span>User Request</span></a></li>
						<li><a href="cloud_share.jsp"><span>Share Files</span></a></li>
						...
						<tbody>
							<tr>
								<%
									...
									ResultSet rs;
									try {
										String sql = "select * from oreg where role='Owner' and status='No'";
								...
								<td><a href="activate.jsp?id=<%=rs.getInt(1)%>">Update</a></td>
							</tr>
							<%
								}
								} catch (Exception e) {
