			...
			<div class="header_resize">
				...
				<div class="menu_nav">
					<ul>
						...
						<li class="active"><a href="UserDetails.jsp"><span>User
									Request</span></a></li>
						...
						<tbody>
							<tr>
								<%
									...
									ResultSet rs;
									try {
										String sql = "select * from oreg where role='User' and status='No'";
								...
								<td><a href="activate1.jsp?id=<%=rs.getInt(1)%>">Update</a></td>
							</tr>
							<%
								}
								} catch (Exception e) {
