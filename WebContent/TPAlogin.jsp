...
<body>
	...
	<div class="loginBox">
		...
		<h2>TPA Login Here</h2>

		<form action="TPAlogincheck.jsp" method="get"
			enctype="multipart/form-data">
			<!-- <form name="Form" action="" onsubmit="return validateForm()"> -->

			<p>Name:</p>
			<i class="fa fa-user icon"></i> <input class="input-field"
				type="text" name="name" placeholder="Enter Username" required>
			<p>Password:</p>
			<i class="fa fa-key icon"></i> <input class="input-field"
				type="password" name="password" id="myInput"
