			...
			<div class="header_resize">
				...
				<div class="menu_nav">
					<ul>
						...
						<li class="active"><a href="UserResponse.jsp"><span>User
									Response</span></a></li>
						<li><a href="downDetails.jsp"><span>Download View</span></a></li>
						...
						<tbody>
							<tr>
								<%
									...
									ResultSet rs;
									try {
										String sql = "select * from request where status='No'";
								...
								<td><a href="mail.jsp?id=<%=rs.getInt(1)%>">Update</a></td>
							</tr>
							<%
								}
								} catch (Exception e) {
